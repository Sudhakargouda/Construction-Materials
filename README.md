<h1 align="center">
    e-Shop For Construction Material
</h1>
...
ESCM is an ecommerce site developed using the MERN (MongoDB, Express.js, React, Node.js) stack. It offers a user-friendly and efficient shopping experience for customers, while providing sellers with essential tools to manage their products and sales.

## Features

- **User Registration:** ESCM allows users to register as customers or sellers, enabling a tailored shopping experience.
...
- **Product Search:** ESCM offers a search functionality where customers can find products by name or browse through categories such as Sand, Cement, steels, and more.
