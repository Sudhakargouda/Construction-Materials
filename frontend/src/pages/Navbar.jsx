...
<Box sx={{ flexGrow: 1, display: { xs: 'flex', md: 'none' }, }}>
    ...
    >
        <MenuItem component={Link} to="/construction-calculator" onClick={handleMenuClose}>
            Construction Cost Calculator
        </MenuItem>
        <MenuItem component={Link} to="/concrete-calculator" onClick={handleMenuClose}>
            Concrete for Slabs Calculator
        </MenuItem>
        <MenuItem component={Link} to="/paints-calculator" onClick={handleMenuClose}>
            Paints Calculator
        </MenuItem>
    </Menu>
</Box>
...
<Box sx={{ flexGrow: 1, display: { xs: 'none', md: 'flex' } }}>
    ...
    >
        ...
        {/* <MenuItem component={Link} to="/raw-material-calculator" onClick={handleMenuClose}>
            Raw Material Calculator
        </MenuItem> */}
        <MenuItem component={Link} to="/paints-calculator" onClick={handleMenuClose}>
            Paints Calculator
        </MenuItem>
        {/* <MenuItem component={Link} to="/ready-mix-calculator" onClick={handleMenuClose}>
