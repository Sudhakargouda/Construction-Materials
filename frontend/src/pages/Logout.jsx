...
const Logout = () => {
  ...
  return (
    <LogoutContainer>
     <Helmet>
    <title>Logout - Construction Materials</title>
    <meta
      name="description"
    ...
    />
    <meta name="keywords" content="logout, log out, account security, construction materials, deals" />
    <meta property="og:title" content="Logout - Construction Materials" />
    <meta
