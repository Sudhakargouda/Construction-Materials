...
const ShippingPage = ({ handleNext, profile }) => {
  ...
  return (
    <React.Fragment>
      <Helmet>
        <title>Shipping Address - Construction Materials</title>
        <meta
          name="description"
          content="Enter your shipping address details. Update or edit your shipping information for smooth order processing. Construction materials, shipping details, address form."
        />
        <meta
          name="keywords"
          content="shipping address, construction materials, order processing, address form, shipping details, edit shipping information"
        />
      </Helmet>
